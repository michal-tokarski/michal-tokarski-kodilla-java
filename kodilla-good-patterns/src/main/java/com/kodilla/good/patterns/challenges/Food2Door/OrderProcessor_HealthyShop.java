...
public class OrderProcessor_HealthyShop implements OrderProcessor {

    final String constantVendorID = "V_0003";
    ...
    public void process(ShoppingItem shoppingItem) {
        ...
        if (checkIfInStock(productID, orderedQuantity, stockQuantity)) {
            ...
            if (checkIfMinimumOrderQuantity(productID, orderedQuantity, minimumOrderQuantity)) {
                ...
                // **************************************************
                // Additional messaging from Healthy Shop :
                if (shoppingItem.getIsCustomerBlacklisted()) {
                    System.out.println("<< " + "Requested delivery is put on hold until the customer status is clarified" + " >>");
                }
                // **************************************************
