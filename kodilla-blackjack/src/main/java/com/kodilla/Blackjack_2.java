...
public class Blackjack_2 extends Application {

    private Image imageback = new Image("cards_table.png");
    private Image card = new Image("card_ace_diamonds.png");
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Scene scene = new Scene(grid, 1600, 900, Color.DARKRED);

        primaryStage.setTitle("BlackJack_2");
