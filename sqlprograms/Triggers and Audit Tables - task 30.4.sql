...
BEGIN
	INSERT INTO BOOKS_AUD (EVENT_DATE, EVENT_TYPE, 
		BOOK_ID, NEW_BOOK_ID, NEW_TITLE, NEW_PUBYEAR, NEW_BESTSELLER, 
        OLD_BOOK_ID, OLD_TITLE, OLD_PUBYEAR, OLD_BESTSELLER)
		VALUES (CURTIME(), "UDPATE", 
        OLD.BOOK_ID, NEW.BOOK_ID, NEW.TITLE, NEW.PUBYEAR, NEW.BESTSELLER, 
        OLD.BOOK_ID, OLD.TITLE, OLD.PUBYEAR, OLD.BESTSELLER);
END $$
DELIMITER ;

-- Doublecheck :
UPDATE BOOKS SET TITLE = "The Big Prince" 
	WHERE BOOK_ID = 4; 
...
BEGIN
	INSERT INTO READERS_AUD (EVENT_DATE, EVENT_TYPE, 
		READER_ID,  NEW_FIRSTNAME, NEW_LASTNAME, NEW_PESELID, NEW_VIP_LEVEL)
		VALUES (CURTIME(), "INSERT", 
...
INSERT INTO READERS(FIRSTNAME, LASTNAME, PESELID, VIP_LEVEL)
     VALUES ("Axl W.", "Rose", "666", "nobody knows");
